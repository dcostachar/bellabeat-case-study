...
library("lubridate")
library("ggplot2")
# renv::snapshot() # Uncomment this when running locally and you have added new libraries
```
...
We'll begin by using the `ggplot2` package that we have loaded earlier. 
